...
public class BuyHealthPolicyNegativeTest  extends DriverSetup{
	...
	String tcName = "BuyHealthPolicyNegativeTest";
...
public static void main(String... args)
{
	...
	@Test(description="proceed to payment",dependsOnMethods = { "testValidCustomerDetails" })
